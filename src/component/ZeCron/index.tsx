  ...
  return (
    <>
      <Input
        ...
        {...option}
        addonAfter={<SettingOutlined onClick={handleCronOpen} />}
      />
      <Modal
        width={800}
        open={cronShow}
        footer={null}
        onCancel={() => setCronShow(false)}
      >
        <QnnCron
          value={value || localValue}
          ...
          footer={
            <>
              <Button
                type="primary"
                style={{ width: 64 }}
                onClick={() => handleCronFinish(cronRef.getValue())}
              >
                生成
              </Button>
              <div className="extraBox">
                <div className="flexbox">
                  <Input
                    readOnly
                    addonBefore={"秒"}
                    style={{ marginBottom: ".5em", flexBasis: "33%" }}
                    value={second}
                  />
                  <Input
                    readOnly
                  ...
                  <Input
                    readOnly
                    addonBefore={"时"}
                    style={{ marginBottom: ".5em", flexBasis: "32%" }}
                    value={hour}
                  />
                  <Input
                    readOnly
                  ...
                  <Input
                    readOnly
                    addonBefore={"式"}
                    style={{ marginBottom: ".5em", flexBasis: "66%" }}
                    value={temp}
                  />
                </div>
              ...
              <div className="cronbtns">
                ...
                <Button
                  type="primary"
                  onClick={() => handleCronOk(cronRef.getValue())}
                >
                  确认
                </Button>
              </div>
